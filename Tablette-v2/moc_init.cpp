...
**
** Created: Tue 16. Apr 16:00:18 2013
...
static const char qt_meta_stringdata_init[] = {
    "init\0\0on_pushButton_clicked()\0"
};
...
const QMetaObjectExtraData init::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject init::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_init,
      qt_meta_data_init, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &init::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_init))
