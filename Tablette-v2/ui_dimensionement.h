...
"	background-color: lightgray}"));
        ...
        lineEdit = new QLineEdit(dimensionement);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setMaximumSize(QSize(1280, 800));
...
" }"));
        ...
        lineEdit_2 = new QLineEdit(dimensionement);
        lineEdit_2->setObjectName(QString::fromUtf8("lineEdit_2"));
        lineEdit_2->setMaximumSize(QSize(1280, 800));
...
" }"));
        ...
        lineEdit_3 = new QLineEdit(dimensionement);
        lineEdit_3->setObjectName(QString::fromUtf8("lineEdit_3"));
        lineEdit_3->setMaximumSize(QSize(1280, 800));
